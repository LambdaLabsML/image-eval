document.addEventListener('DOMContentLoaded', () => {
    fetch('/home/eole/Workspaces/image-eval/prompts/all_category.txt')
        ...
        .then(data => {
            ...
            prompts.forEach((prompt, index) => {
                ...
                modelAVideo.src = `/home/eole/Desktop/sora1.2/sample_${index.toString().padStart(4, '0')}.mp4`;
                ...
                modelBVideo.src = `/home/eole/Desktop/sora1.2/sample_${index.toString().padStart(4, '0')}.mp4`;
